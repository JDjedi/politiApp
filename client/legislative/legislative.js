...
if (Meteor.isClient) {
	...
	Template.tweetAppRequestSenMajLdr.onRendered(function(){
	...
	Template.tweetAppRequestSenMinLdr.onRendered(function(){
	...
	Template.tweetAppRequestHouseMajLdr.onRendered(function(){
	...
	Template.tweetAppRequestHouseMinLdr.onRendered(function(){
